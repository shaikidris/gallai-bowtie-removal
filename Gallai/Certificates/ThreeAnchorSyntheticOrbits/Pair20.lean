...
theorem pair_chunk_20 : ∀ rem : Fin 32,
    highPair (⟨20 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨20 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨20 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
