...
theorem pair_chunk_6 : ∀ rem : Fin 32,
    highPair (⟨6 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨6 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨6 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
