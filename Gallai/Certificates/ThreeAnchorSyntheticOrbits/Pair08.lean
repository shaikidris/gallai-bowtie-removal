...
theorem pair_chunk_8 : ∀ rem : Fin 32,
    highPair (⟨8 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨8 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨8 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
