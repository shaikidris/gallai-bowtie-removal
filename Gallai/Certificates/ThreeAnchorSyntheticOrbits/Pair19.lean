...
theorem pair_chunk_19 : ∀ rem : Fin 32,
    highPair (⟨19 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨19 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨19 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
