...
theorem pair_chunk_16 : ∀ rem : Fin 32,
    highPair (⟨16 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨16 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨16 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
