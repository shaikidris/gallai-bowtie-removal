...
theorem pair_chunk_7 : ∀ rem : Fin 32,
    highPair (⟨7 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨7 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨7 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
