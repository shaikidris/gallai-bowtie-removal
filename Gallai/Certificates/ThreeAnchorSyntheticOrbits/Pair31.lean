...
theorem pair_chunk_31 : ∀ rem : Fin 32,
    highPair (⟨31 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨31 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨31 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
