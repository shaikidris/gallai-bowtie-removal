...
theorem pair_chunk_17 : ∀ rem : Fin 32,
    highPair (⟨17 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨17 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨17 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
