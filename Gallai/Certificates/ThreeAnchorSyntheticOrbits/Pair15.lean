...
theorem pair_chunk_15 : ∀ rem : Fin 32,
    highPair (⟨15 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨15 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨15 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
