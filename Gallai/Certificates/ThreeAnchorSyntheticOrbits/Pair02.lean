...
theorem pair_chunk_2 : ∀ rem : Fin 32,
    highPair (⟨2 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨2 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨2 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
