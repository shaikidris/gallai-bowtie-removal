...
theorem pair_chunk_24 : ∀ rem : Fin 32,
    highPair (⟨24 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨24 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨24 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
