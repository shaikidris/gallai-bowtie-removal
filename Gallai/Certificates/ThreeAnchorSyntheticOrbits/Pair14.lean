...
theorem pair_chunk_14 : ∀ rem : Fin 32,
    highPair (⟨14 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨14 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨14 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
