...
theorem pair_chunk_28 : ∀ rem : Fin 32,
    highPair (⟨28 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨28 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨28 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
