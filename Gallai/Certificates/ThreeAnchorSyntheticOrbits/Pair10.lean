...
theorem pair_chunk_10 : ∀ rem : Fin 32,
    highPair (⟨10 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨10 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨10 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
