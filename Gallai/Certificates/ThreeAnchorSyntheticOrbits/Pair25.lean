...
theorem pair_chunk_25 : ∀ rem : Fin 32,
    highPair (⟨25 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨25 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨25 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
