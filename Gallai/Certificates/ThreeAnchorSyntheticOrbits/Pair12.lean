...
theorem pair_chunk_12 : ∀ rem : Fin 32,
    highPair (⟨12 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨12 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨12 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
