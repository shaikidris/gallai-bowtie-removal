...
theorem pair_chunk_1 : ∀ rem : Fin 32,
    highPair (⟨1 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨1 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨1 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
