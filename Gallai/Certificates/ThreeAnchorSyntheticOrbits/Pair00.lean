...
theorem pair_chunk_0 : ∀ rem : Fin 32,
    highPair (⟨0 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨0 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨0 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
