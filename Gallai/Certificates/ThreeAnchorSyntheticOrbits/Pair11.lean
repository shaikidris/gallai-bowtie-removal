...
theorem pair_chunk_11 : ∀ rem : Fin 32,
    highPair (⟨11 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨11 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨11 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
