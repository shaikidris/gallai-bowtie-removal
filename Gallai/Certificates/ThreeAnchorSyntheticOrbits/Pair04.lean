...
theorem pair_chunk_4 : ∀ rem : Fin 32,
    highPair (⟨4 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨4 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨4 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
