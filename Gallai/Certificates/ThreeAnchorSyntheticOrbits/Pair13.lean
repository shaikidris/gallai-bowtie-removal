...
theorem pair_chunk_13 : ∀ rem : Fin 32,
    highPair (⟨13 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨13 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨13 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
