...
theorem pair_chunk_21 : ∀ rem : Fin 32,
    highPair (⟨21 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨21 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨21 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
