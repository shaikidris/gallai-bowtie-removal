...
theorem pair_chunk_18 : ∀ rem : Fin 32,
    highPair (⟨18 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨18 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨18 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
