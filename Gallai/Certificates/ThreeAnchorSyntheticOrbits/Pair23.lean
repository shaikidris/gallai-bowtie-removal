...
theorem pair_chunk_23 : ∀ rem : Fin 32,
    highPair (⟨23 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨23 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨23 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
