...
theorem pair_chunk_22 : ∀ rem : Fin 32,
    highPair (⟨22 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨22 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨22 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
