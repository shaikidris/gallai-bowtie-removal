...
theorem pair_chunk_3 : ∀ rem : Fin 32,
    highPair (⟨3 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨3 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨3 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
