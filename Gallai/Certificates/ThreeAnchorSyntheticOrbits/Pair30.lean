...
theorem pair_chunk_30 : ∀ rem : Fin 32,
    highPair (⟨30 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨30 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨30 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
