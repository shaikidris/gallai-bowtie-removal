...
theorem pair_chunk_9 : ∀ rem : Fin 32,
    highPair (⟨9 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨9 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨9 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
