...
theorem pair_chunk_26 : ∀ rem : Fin 32,
    highPair (⟨26 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨26 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨26 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
