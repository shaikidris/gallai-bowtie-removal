...
theorem pair_chunk_5 : ∀ rem : Fin 32,
    highPair (⟨5 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨5 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨5 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
