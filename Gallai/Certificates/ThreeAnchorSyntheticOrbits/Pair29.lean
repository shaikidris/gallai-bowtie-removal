...
theorem pair_chunk_29 : ∀ rem : Fin 32,
    highPair (⟨29 * 32 + rem.val, by omega⟩ : Fin 1024) →
    (⟨29 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ syntheticCodes ∨
    (⟨29 * 32 + rem.val, by omega⟩ : Fin 1024) ∈ retainedCodes := by decide
